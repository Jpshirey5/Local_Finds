...
var showPhotos = document.getElementsByClassName('showPhotos');
var showReviews = document.getElementsByClassName('showReviews');
...
function getYelp(event) {
    ...
    fetch('https://cors-anywhere.herokuapp.com/api.yelp.com/v3/businesses/search?location=' + townUrl(town.value) + '&term=' + businessUrl(business.value) + '&sort_by=best_match&limit=20', yelpPull)
        ...
        .then(function (response) {
            ...
            map.setView([radarLat, radarLong], 19)
...
// TODO: Create objects, one for the coordinates, one for the addresses, one for the images
// access it using the key (coordinates)

// function onMapClick(e) {
//     console.log("See what's printing")
//     console.log(e.latlng)
//     console.log(e.latlng.lat)
//     console.log(e.target);
//     console.log(e.target._container.classList.contains('leaflet-pane'));
//     // TODO:
//     // FIXME:
//     if (true){
...
function setUserEnteredLocation(posLatitude, posLongitude) {
    L.marker([posLatitude, posLongitude]).addTo(map);
